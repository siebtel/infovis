...
function lowercase() {
  ...
  d3.selectAll("#_1").attr("class", "highlighted-background");
  d3.selectAll("#_2").attr("class", "highlighted-background");
  d3.selectAll("#_9").attr("class", "highlighted-background");
  ...
  d3.selectAll("#_1").transition().delay(1000).attr("class", "highlighted-background-rem");
  d3.selectAll("#_2").transition().delay(1000).attr("class", "highlighted-background-rem");
  d3.selectAll("#_9").transition().delay(1000).attr("class", "highlighted-background-rem");
}
...
function removingSpecial() {
  ...
  d3.selectAll("#_1").attr("class", "highlighted-background");
  d3.selectAll("#_12").attr("class", "highlighted-background");
  ...
  d3.selectAll("#_1").transition().delay(1000).attr("class", "highlighted-background-rem");
  d3.selectAll("#_12").transition().delay(1000).attr("class", "highlighted-background-rem");
}
...
function stopwords() {
  ...
  d3.selectAll("#_3").attr("class", "highlighted-background");
  d3.selectAll("#_4").attr("class", "highlighted-background");
  d3.selectAll("#_5").attr("class", "highlighted-background");
  d3.selectAll("#_6").attr("class", "highlighted-background");
  d3.selectAll("#_8").attr("class", "highlighted-background");
  d3.selectAll("#_10").attr("class", "highlighted-background");
  d3.selectAll("#_11").attr("class", "highlighted-background");
...
function stemming() {
  ...
  d3.selectAll("#_1").attr("class", "highlighted-background");
  d3.selectAll("#_2").attr("class", "highlighted-background");
  d3.selectAll("#_7").attr("class", "highlighted-background");
  d3.selectAll("#_9").attr("class", "highlighted-background");
  d3.selectAll("#_12").attr("class", "highlighted-background");
  ...
  d3.selectAll("#_1").transition().delay(1000).attr("class", "highlighted-background-rem");
  d3.selectAll("#_2").transition().delay(1000).attr("class", "highlighted-background-rem");
  d3.selectAll("#_7").transition().delay(1000).attr("class", "highlighted-background-rem");
  d3.selectAll("#_9").transition().delay(1000).attr("class", "highlighted-background-rem");
  d3.selectAll("#_12").transition().delay(1000).attr("class", "highlighted-background-rem");
